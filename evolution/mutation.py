...
def mutation(some_allocation):
    ...
    while (number_of_mutations > 0):
        ...
        if first_function.servidores_alocados and second_function.servidores_alocados:
            ...
            if str(second_function.funcao) != 'nan':
                if (((first_servers.servidores_alocados[random_server_1].cargo in second_function.funcao) or
                    (first_function.servidores_alocados[random_server_1].funcao in second_function.funcao) and
                    (second_function.servidores_alocados[random_server_2].cargo in first_function.funcaoo) or
                    (second_function.servidores_alocados[random_server_2].funcao in first_function.funcao)) and
                     ...
                     second_function.horas_slotadas <= first_function.horas_slotadas + first_function.forca_de_trabalho_s or
                     first_function.horas_slotadas <= second_function.horas_slotadas + second_function.forca_de_trabalho_s and
